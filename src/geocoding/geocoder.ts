/**
 * Geo-Rev by stuchl4n3k forked by @strawberryChocolateFudge to add browser support
 *
 ...
 */
export async function createRevGeocoder(
...
export class RevGeocoder {
    ...
    public async init(): Promise<RevGeocoder> {
        this.records = await parseDataset(this.dataset as string);
